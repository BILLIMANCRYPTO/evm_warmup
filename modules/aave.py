...
aave_contract_abi = abi_data['aave']
aave_contract_address = "0xecD4bd3121F9FD604ffaC631bF6d41ec12f1fafb"  # Адрес контракта
...
# Radiant
def aave_deposit(wallet_address, private_key, web3, i, GAS_PRICE):
    # Инициализация контракта
    aave_contract = web3.eth.contract(address=web3.to_checksum_address(aave_contract_address),
                                         abi=aave_contract_abi)
    ...
    gas_limit = web3.eth.estimate_gas({
        'from': wallet_address,
        'to': aave_contract_address,
        'value': payable_amount,
        'data': aave_contract.encodeABI(fn_name='depositETH', args=[pool, onBehalfOf, referral_code]),
    })
